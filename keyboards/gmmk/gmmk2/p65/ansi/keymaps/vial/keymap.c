...
[_FL] = LAYOUT(
  ...
  _______,  _______,  RGB_VAD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MUTE,             KC_INS,
  PERKEY_TOG, RGB_HUI, RGB_HUD, RGB_SPD,  RGB_SPI,  RGB_RMOD, RGB_MOD,  _______,  KC_MPRV,  KC_MNXT,  KC_MPLY,  _______,             KC_PGUP,  _______,
...
const char miscCharKeys[] = {11, 12, 13, 15, 26, 27, 28, 40, 41, 42, 52, 53, 54, 61, 43, 57};
const uint8_t miscCharKeyCount = 16;

const char modKeys[] = {44, 55, 58, 59, 60, 62, 63, 14, 29};
const uint8_t modKeyCount = 9;
