...
[_FL] = LAYOUT(
  ...
  _______,  _______,  RGB_VAD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MUTE,             KC_PGUP,
  PERKEY_TOG, RGB_HUI, RGB_HUD, RGB_SPD,  RGB_SPI,  _______,  _______,  _______,  RGB_RMOD, RGB_MOD,  _______,  KC_MPLY,             KC_VOLU,  KC_PGDN,
